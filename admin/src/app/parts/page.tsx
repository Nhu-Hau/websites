          ...
          <div className="text-xs text-zinc-700 mt-1 space-y-1">
            {(() => {
              ...
              if (typeof tests === 'undefined' || !Array.isArray(tests)) {
                return <div>Đang tải hoặc không có dữ liệu tests.</div>;
              }
              ...
              return (
                <div className="grid grid-cols-2 gap-x-4">
                  {sortedParts.map(([partName, testSet]) => (
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-600 mt-1 leading-relaxed whitespace-pre-wrap">{confirmDialog.description}</p>
            </div>
          </div>
