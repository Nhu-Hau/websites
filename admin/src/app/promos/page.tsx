      ...
      <header className="bg-white rounded-xl shadow-lg p-4 border border-zinc-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-zinc-900">Doanh thu & Khuyến mãi</h1>
              <p className="text-xs text-zinc-600 mt-0.5">Quản lý đơn hàng và mã giảm giá</p>
            </div>
          </div>
          <nav className="flex items-center gap-2">
            <Link
              className="px-3 py-1.5 text-sm rounded-lg border border-zinc-300 hover:bg-zinc-50 transition-colors flex items-center gap-2 font-medium"
              href="/"
            >
