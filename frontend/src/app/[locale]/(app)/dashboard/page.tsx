...
function GoalProgressSkeleton() {
  return (
    <div className="rounded-3xl border-2 border-white/30 bg-white/95 dark:bg-zinc-800/95 backdrop-blur-xl p-6 shadow-2xl ring-2 ring-white/20 dark:ring-zinc-800/50">
      <div className="flex items-center gap-3 mb-5">
        <div className="p-3 rounded-2xl bg-gradient-to-br from-violet-600 to-purple-600 shadow-xl ring-2 ring-white/50">
          <div className="w-7 h-7 bg-white/30 rounded animate-pulse" />
        </div>
...
function StudyScheduleSkeleton() {
  return (
    <div className="rounded-3xl border-2 border-white/30 bg-white/95 dark:bg-zinc-800/95 backdrop-blur-xl p-6 shadow-2xl ring-2 ring-white/20 dark:ring-zinc-800/50">
      <div className="flex items-center gap-3 mb-5">
        <div className="p-3 rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-600 shadow-xl ring-2 ring-white/50">
          <div className="w-7 h-7 bg-white/30 rounded animate-pulse" />
        </div>
...
function PracticeProgressChartSkeleton() {
  return (
    <div className="h-full flex flex-col rounded-3xl border-2 border-white/30 bg-white/95 dark:bg-zinc-800/95 backdrop-blur-xl p-6 shadow-2xl ring-2 ring-white/20 dark:ring-zinc-800/50">
...
export default async function DashboardPage() {
  return (
    <div className="min-h-screen bg-[#DFD0B8] dark:from-zinc-950 dark:to-zinc-900 pt-20">
      <div className="mx-auto max-w-[1380px] px-4 sm:px-6 lg:px-8">
{/* Header Dashboard – Có nền card, nhỏ gọn, góc trái, icon 3D + hover mượt */}
<div className="group mb-8">
  <div className="relative inline-flex items-center gap-4 rounded-3xl bg-white/90 dark:bg-zinc-800/90 backdrop-blur-xl px-6 py-4 shadow-xl ring-2 ring-white/30 dark:ring-zinc-700/50 transition-all duration-500 hover:shadow-2xl hover:scale-[1.005] hover:ring-indigo-300/50 dark:hover:ring-indigo-600/50 overflow-hidden">
    ...
    <div className="relative transform-gpu transition-all duration-400 group-hover:scale-110 group-hover:-rotate-3">
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 shadow-lg ring-3 ring-white/50 dark:ring-zinc-800/50">
      ...
      <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-indigo-400/40 to-pink-400/40 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
    </div>
    ...
    <div className="relative">
      ...
      {/* 3D Shadow Layer */}
      <h1 className="absolute -left-0.5 top-0.5 text-2xl sm:text-3xl lg:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 opacity-0 group-hover:opacity-30 blur-sm transition-all duration-400">
        Bảng điều khiển
      </h1>
    </div>

    {/* Subtitle nhỏ gọn */}
    <p className="absolute left-[5.5rem] top-full mt-1 text-xs sm:text-sm lg:text-base text-zinc-600 dark:text-zinc-400 font-medium transition-colors duration-300 group-hover:text-zinc-700 dark:group-hover:text-zinc-300 whitespace-nowrap">
