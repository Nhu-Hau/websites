      ...
      <li className="flex">
        {item.href ? (
          <Link
            ...
            className="relative block whitespace-nowrap text-black dark:text-white transition-colors group hover:text-tealCustom"
          >
            <span>{item.label}</span>
            <span
              className={[
                "pointer-events-none absolute -bottom-0.5 left-0 h-0.5 bg-tealCustom",
    ...
    <li className={`relative ${isMobile ? "flex flex-col" : "group"} h-full`}>
      ...
      >
        {item.href ? (
          <Link
            href={item.href}
            className="relative block whitespace-nowrap px-0 text-black dark:text-white transition-colors group/parent hover:text-tealCustom"
            aria-current={isActive ? "page" : undefined}
          >
            <span>{item.label}</span>
            {/* underline animate */}
            <span
              className={[
                "pointer-events-none absolute left-0 -bottom-0.5 h-0.5 bg-tealCustom",
          ...
          <span className="relative block whitespace-nowrap px-0 py-2 text-black dark:text-white">
            <span>{item.label}</span>
            <span className="pointer-events-none absolute left-0 -bottom-0.5 h-0.5 w-0 bg-tealCustom transition-all duration-300 ease-out group-hover:w-full" />
          </span>
        )}
