...
export default function ChatPanel() {
  ...
  const content = (
    <motion.div
      ...
      className="hidden md:block fixed bottom-24 right-6 z-[9999] w-full max-w-md pointer-events-auto"
    >
      ...
      <div className="flex flex-col h-[460px] max-h-[calc(100vh-7rem)] bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-zinc-700 overflow-hidden">
        {/* Header + Tabs */}
        <div className="relative flex-shrink-0 border-b border-gray-200 dark:border-zinc-700">
          <div className="flex">
            <button
